        ...
        >
                ...
                {Object.keys(WORKOUTS).map((type, typeIndex) => {
                    return (
                        <button
                            ...
                            className={
                                "bg-slate-950 border duration-200 px-4 hover:border-blue-600 py-3 cursor-pointer rounded-lg " +
                                (type === poison
                                    ? "border-blue-600"
                                    : "border-blue-400")
                            }
            ...
            <div className="bg-slate-950  border border-soild border-blue-400 rounded-lg flex flex-col">
                ...
                >
                    ...
                    <i class="fa-solid absolute right-3 top-0.5 translate-y-0.5 fa-caret-down"></i>
                </button>
                {showModal && (
                ...
                {Object.keys(SCHEMES).map((scheme, schemeIndex) => {
                    return (
                        <button
                            ...
                            className={
                                "bg-slate-950 border  duration-200 hover:border-blue-600 py-3 cursor-pointer rounded-lg px-4 " +
                                (scheme === goal
                                    ? " border-blue-600"
                                    : " border-blue-400")
                            }
