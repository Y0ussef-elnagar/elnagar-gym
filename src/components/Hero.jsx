...
const Hero = () => {
    return (
        <div className="min-h-screen flex flex-col gap-10 items-center justify-center text-center max-w-200 w-full mx-auto p-4">
            <div className="flex flex-col gap-4">
                <p>It's time to get</p>
                <h1 className="font-semibold text-4xl sm:text-5xl md:text-6xl lg:text-7xl">
                    BEAST<span className="text-blue-400">NORMOUS</span>
                </h1>
            </div>
